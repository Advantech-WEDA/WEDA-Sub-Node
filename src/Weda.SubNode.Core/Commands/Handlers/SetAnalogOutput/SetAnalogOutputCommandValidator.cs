...
/// <summary>
/// Validator for SetAnalogOutputCommand with complex validation logic.
/// </summary>
/// <remarks>
/// Validates:
...
/// </remarks>
public class SetAnalogOutputCommandValidator : ICommandValidator<SetAnalogOutputCommand>
{
    public ErrorOr<Success> Validate(SetAnalogOutputCommand command)
    {
