...
/// <summary>
/// Status codes for SetDigitalOutput command execution result.
/// </summary>
public static class SetDigitalOutputStatusCode
{
    /// <summary>
    ...
    /// <summary>
    /// Device does not support digital output control.
    /// </summary>
    ...
    public static string GetDescription(int code) => code switch
    {
        ...
        NotSupported => "Device does not support digital output control",
