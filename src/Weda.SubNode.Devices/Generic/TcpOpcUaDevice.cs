...
/// <summary>
/// Pre-configured OPC-UA device using Request-Response pattern (polling).
/// Automatically creates OpcUaCommunication from DeviceConfiguration.
/// </summary>
public class TcpOpcUaRequestResponseDevice : OpcUaRequestResponseDevice
{
    public TcpOpcUaRequestResponseDevice(IWedaApplicationContext context, string configKey)
        : this(context, context[configKey])
    {
    }

    public TcpOpcUaRequestResponseDevice(
