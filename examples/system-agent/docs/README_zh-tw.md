...
| 順序 | 文件 | 說明 |
|------|------|------|
| 1 | [01_QUICK_START_zh-tw.md](01_QUICK_START_zh-tw.md) | 部署與啟動 |
| 2 | [Metrics/00_DEVICECFG.md](Metrics/00_DEVICECFG.md) | `devicecfg.json` 結構總覽（一頁式） |
| 3 | [v1.0/Sensor-Configuration-and-Usage-Guide_zh-tw.md](v1.0/Sensor-Configuration-and-Usage-Guide_zh-tw.md) | Sensor 配置完整參考（v1.0） |
| 4 | [v1.1/Sensor-Configuration-and-Usage-Guide_zh-tw.md](v1.1/Sensor-Configuration-and-Usage-Guide_zh-tw.md) | v1.1 差異：Auto-detect / Explicit list / Bound mode |
| 5 | [03_DOCKER_DEPLOY_zh-tw.md](03_DOCKER_DEPLOY_zh-tw.md) | Docker 部署指南 |
| 6 | [04_TESTING_GUIDE.md](04_TESTING_GUIDE.md) | 測試指南 |

> **英文版**：英文版為預設檔名（無後綴），中文版使用 `_zh-tw.md` 後綴。
...
```
docs/
├── README.md                          — 導覽（English，預設）
├── README_zh-tw.md                    ← 你在這裡
├── 01_QUICK_START_zh-tw.md            — 快速部署
├── 03_DOCKER_DEPLOY_zh-tw.md          — Docker 詳細部署
├── 04_TESTING_GUIDE.md                — 測試方法
│
├── v1.0/                              — v1.0 基線文件
│   ├── Sensor-Configuration-and-Usage-Guide.md     — Sensor 配置完整參考（English）
│   ├── Sensor-Configuration-and-Usage-Guide_zh-tw.md
│   ├── METRIC-TYPES.md                             — MetricType 欄位詳解（English）
│   └── METRIC-TYPES_zh-tw.md
│
├── v1.1/                              — v1.1 差異文件
│   ├── Sensor-Configuration-and-Usage-Guide.md     — 欄位修改規則 + 三種解析模式（English）
│   ├── Sensor-Configuration-and-Usage-Guide_zh-tw.md
│   ├── METRIC-TYPES.md                             — 解析模式詳細行為（English）
│   └── METRIC-TYPES_zh-tw.md
│
