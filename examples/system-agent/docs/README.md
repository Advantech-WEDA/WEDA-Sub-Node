...
|-------|------|-------------|
| 1 | [01_QUICK_START_zh-tw.md](01_QUICK_START_zh-tw.md) | Deployment & startup |
| 2 | [Metrics/00_DEVICECFG.md](Metrics/00_DEVICECFG.md) | `devicecfg.json` structure overview (one-page) |
| 3 | [v1.0/Sensor-Configuration-and-Usage-Guide.md](v1.0/Sensor-Configuration-and-Usage-Guide.md) | Full Sensor configuration reference (v1.0) |
| 4 | [v1.1/Sensor-Configuration-and-Usage-Guide.md](v1.1/Sensor-Configuration-and-Usage-Guide.md) | v1.1 differences: Auto-detect / Explicit list / Bound mode |
| 5 | [03_DOCKER_DEPLOY_zh-tw.md](03_DOCKER_DEPLOY_zh-tw.md) | Docker deployment guide |
| 6 | [04_TESTING_GUIDE.md](04_TESTING_GUIDE.md) | Testing guide |

> **Chinese versions**: Each English doc has a corresponding `_zh-tw.md` version in the same directory.
...
├── README_zh-tw.md                    — Navigation (Chinese)
├── 01_QUICK_START_zh-tw.md            — Quick deployment (zh-tw)
├── 03_DOCKER_DEPLOY_zh-tw.md          — Docker deployment (zh-tw)
