...
> 本文件僅說明 v1.1 與 v1.0 的差異。完整欄位說明請參閱 [v1.0 Sensor-Configuration-and-Usage-Guide](../v1.0/Sensor-Configuration-and-Usage-Guide_zh-tw.md)。
...
> 展開後的命名規則、邊界行為等細節請參閱 [METRIC-TYPES v1.1](METRIC-TYPES_zh-tw.md#展開後的命名規則)。
...
以下內容與 v1.0 完全一致，請參閱 [v1.0 文件](../v1.0/Sensor-Configuration-and-Usage-Guide_zh-tw.md)：
