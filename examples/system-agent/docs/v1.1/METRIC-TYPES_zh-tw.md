...
> v1.0 已有的 MetricType 分類、Sensor 配置結構、安全性檢查等基礎說明，請參閱 [METRIC-TYPES v1.0](../v1.0/METRIC-TYPES_zh-tw.md)。
> Sensor 配置欄位快速參考與 v1.1 參數變更對照，請參閱 [Sensor 配置快速參考 v1.1](Sensor-Configuration-and-Usage-Guide_zh-tw.md)。
