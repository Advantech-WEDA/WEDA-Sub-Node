...
> This document only covers changes between v1.1 and v1.0. For full field descriptions, see [v1.0 Sensor-Configuration-and-Usage-Guide](../v1.0/Sensor-Configuration-and-Usage-Guide_en.md).
...
The following remain identical to v1.0. See [v1.0 documentation](../v1.0/Sensor-Configuration-and-Usage-Guide_en.md):
