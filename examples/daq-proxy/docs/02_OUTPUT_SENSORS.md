...
The Feature Proxy publishes **4 output sensors** to the cloud as standard SubNode telemetry. These sensors represent the results of calling the PHM Inference Service with features received from `daq-collector`.
